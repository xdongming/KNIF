...
def train_alternating(
    ...
    num_epochs=50, batch_size=64, lr_g=1e-3, lr_K=1e-2,
...
if __name__ == '__main__':
    ...
    g_model = load_g_model("model_checkpoint_limit.ckpt", model)
    g_model, K = train_alternating(g_model, HX_train, HU_train, dim, dim+n_feature, num_epochs, batch_size, lr_g, lr_K, save_dir="./", model_name="limit")
