...
if __name__ == '__main__':
    ...
    g_model = load_g_model("model_checkpoint_SG.ckpt", model)
    g_model, K = train_alternating(g_model, H_train, dim, dim+n_feature, num_epochs, batch_size, lr_g, lr_K, save_dir="./", model_name="SG")
